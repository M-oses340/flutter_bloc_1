          ...
          builder: (context, state) {
            ...
            if (state is CategoryLoaded) {
              ...
              return RefreshIndicator(
                // FIXED: Changed 'onPressed' to 'onRefresh'
                onRefresh: () async {
                  context.read<CategoryBloc>().add(GetCategories(shopId));
                  // We add a small delay so the indicator doesn't flicker away instantly
                  await Future.delayed(const Duration(milliseconds: 500));
                },
                child: ListView.builder(
                  // physics ensures the list is always scrollable so pull-to-refresh works
